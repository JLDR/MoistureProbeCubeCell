...
uint8_t devEui[8] PROGMEM = {0xDE, 0xAD, 0xDE, 0xAD, 0x00, 0x08, 0xDE, 0xAD};             // test avec 0xDEADDEAD0008DEAD
uint8_t appEui[8] PROGMEM = {0xDE, 0xAD, 0x42, 0xDE, 0xAD, 0x42, 0xDE, 0xAD};             // neOCamous-Lora test 0xDEAD42DEAD42DEAD
...
uint8_t appKey[16] PROGMEM = {0x01, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF, 0x01, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF};   // 0x0123456789ABCDEF0123456789ABCDEF
/* ABP mode (doit être mentionné obligatoirement même si le mode OTAA est choisi) */
uint8_t nwkSKey[] PROGMEM = {0x8E, 0x62, 0xC9, 0xD9, 0x50, 0xCA, 0xF9, 0xCD, 0x6B, 0x8B, 0x42, 0xCB, 0x92, 0x4F, 0xF0, 0xC1};
uint8_t appSKey[] PROGMEM = {0xC4, 0x7A, 0x95, 0xF4, 0x12, 0xB6, 0x66, 0x9C, 0x2E, 0x83, 0xA2, 0x65, 0xD5, 0x5A, 0x71, 0xFE};
uint32_t devAddr = (uint32_t)0xBA34D764;
